...
% Ez a loaddcm fv-nek állítja be, hogy az eredeti pixelértékek vagy a SUV skálázott
% értékek olvasódjanak be
        mia_dicom_scaled = 1; % ha nincs ilyen global változó, akkor SUV skála lesz számolva
else
            ...
            if isfield(dcminfo,'RescaleSlope') && ...
                ...
                if isfield(dcminfo,'Private_7053_1009') %Philips Gemini TF dcm SUV scaled format 
                        ...
                        if dcminfo.RescaleSlope == 1
                            ...
                            BqCal = 1; % ha a RescaleSlope~=1 (kb 2009 szep óta), akkor a RescaleSlope is tartalmazza a 
                                        % Private_7053_1009 értéket, tehát az imaVOL számításakor már  elegendõ 
                                        % a RescaleSlope használata.  
                        end
