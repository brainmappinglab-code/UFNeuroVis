function [dcmSeries, dcmPatient, SeriesList, SeriesListNumInfo, ImageInfos, SeriesInfos] = loaddcmdir(dicomdirpath, returnFullList)
%function [dcmSeries, dcmPatient, SeriesList, SeriesListNumInfo, ImageInfos, SeriesInfos] = loaddcmdir(dicomdirpath, returnFullList)
%
...
%try
    ...
    % create the outputs
    if returnFullList > 0
    dcmSeriesPath = dcmPatient(SeriesListNumInfo(returnFullList).PatientNum). ...
        Study(SeriesListNumInfo(returnFullList).StudyNum). ...
        Series(SeriesListNumInfo(returnFullList).SeriesNum). ...
        ImagePath;
    ...
    dcmSeries.Images = dcmPatient(SeriesListNumInfo(returnFullList).PatientNum). ...
        Study(SeriesListNumInfo(returnFullList).StudyNum). ...
        Series(SeriesListNumInfo(returnFullList).SeriesNum). ...
        ImageNames;
    end
