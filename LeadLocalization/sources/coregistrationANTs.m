...
InputFixImage = [folder,filesep,'anat_t1_acpc.nii'];
InputMoveImage = [folder,filesep,'postop_ct.nii'];

switch linearity
    case 'linear'
        Normalization_CMD = [ANTs_DIR,filesep,'antsRegistration -v ',num2str(Verbose),' -d 3 -o [',xtrmPrefix,',',outputImage,'] -n Linear -u -f 1 -w [0.005,0.095] -a 1 -r [',InputFixImage,',',InputMoveImage,',1] \', ...
