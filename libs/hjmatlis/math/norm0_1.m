function [ ndata ] = norm0_1( data, varargin )
%[ndata] = norm0_1(data[, dir_norm=1])
...
%      - Inf is N/0
    ...
    min1=min(data, [], dir_norm);
    max1=max(data, [], dir_norm);
    
    ndata=bsxfun(@times,bsxfun(@minus,data,min1),1./(max1-min1));
