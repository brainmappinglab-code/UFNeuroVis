...
%%
      ...
      pp3 = splinefit(x,y,8,con,6);

      % Fit a spline of order 6 with constraints and periodicity
      pp4 = splinefit(x,y,breaks,con,6,'p');
      ...
      figure(7)
        ...
        y3 = ppval(pp3,xx);
        y4 = ppval(pp4,xx);
        plot(x,y,'.',xx,[y1;y2;y3;y4]), grid on
        
        legend('data with outliers','spline of order 5','spline of order 3 with periodic boundary condition',...
    'spline with 8 pieces and constraints','spline of order 6 with constraints and periodicity')