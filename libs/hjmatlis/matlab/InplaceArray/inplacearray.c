 ...
 *
 * Class supported: all numerical, logical, char and cell
 *       not supported: sparse and cell
 *
 * Important notes:
...
void mexFunction(int nlhs, mxArray *plhs[],
    ...
    /*if (ClassID==mxSTRUCT_CLASS) // Pi are fieldnames, ref. Pete Boettcher
        ((Internal_mxArray*)(BMAT))->data.number_array.pimag_data = Pi;
    else */
    if (ComplexFlag)
