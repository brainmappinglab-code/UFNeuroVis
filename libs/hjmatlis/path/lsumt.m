function lsout=lsumt(varargin)
    ...
    %
    %NOTE 1: it is a wrapper for dir
    %NOTE 2: this function is case insensitive on windows but case
    %sensitive on unix systems (because of builtin functions)
