function newmap = b2rmap(cmin_input,cmax_input)
...
%   the max value of color values designed.  e.g. colormap(b2rmap(-3,5))
%   
...
%   opposite number
%   e.g. colormap(b2rmap(-3,6))   is from light blue to deep red
%   e.g. colormap(b2rmap(-3,3))   is from deep blue to deep red
%
...
%   updated:  Enrico Opri added the flexibility of using the current climits
%   
%   Examples:
%   ------------------------------
%   figure
%   peaks;
%   colormap(b2rmap(-6,8)), colorbar, title('b2rmap')
%   


%% control the figure caxis 
lims = get(gca, 'CLim');   % get figure caxis formation
if exist('cmin_input','var') && exist('cmax_input','var')
