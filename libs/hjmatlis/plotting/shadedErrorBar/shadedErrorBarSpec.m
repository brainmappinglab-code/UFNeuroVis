function varargout=shadedErrorBarSpec(x,y,errBar,lineProps,transparent,withcolor1)
...
if nargin<6, withcolor1=nan; end



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
% Plot to get the parameters of the line 
if isnan(withcolor1(1))
    H.mainLine=plot(x,y,lineProps{:});
else
    H.mainLine=plot(x,y,lineProps{:},'color',withcolor1);
end
