...
%            is 0.07. Note this vale can cause titles legends and labels to collide with the subplots, while presenting
...
%
% Original version can be found here: http://www.mathworks.se/matlabcentral/fileexchange/39664-subtightplot

if (nargin<4) || isempty(gap),    gap=0.07;  end
if (nargin<5) || isempty(marg_h),  marg_h=0.055;  end
